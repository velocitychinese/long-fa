...
SCENIC_STYLES = [
    "stunning Persian woman in traditional Persian dress, Persepolis ruins, ancient columns, golden sunset",
    "elegant Persian woman in modern clothing, Tehran skyline with Milad Tower, twinkling city lights",
    "beautiful Persian woman in casual wear, Nasir al-Mulk Mosque, colorful stained glass, pink reflection",
    "Persian woman in traditional garb, Isfahan Naqsh-e Jahan Square, blue mosaic tiles, fountains",
    "gorgeous Persian woman in traditional Persian dress, Shiraz gardens, blooming flowers, spring blossoms",
    "beautiful Persian woman with Iran flag, Azadi Tower, soft golden hour light, serene atmosphere",
    "Persian woman in traditional attire, Isfahan Si-o-se-pol bridge, reflected in water at dusk",
    "elegant Persian woman in Persian garden, cypress trees, reflecting pool, peaceful atmosphere",
]


def generate_scenic_image(category_english: str, category_persian: str, output_path: str):
    # Try pre-made thumbnail first
    premade = get_thumbnail("Persian", category_english)
    if premade:
        return premade
        ...
        for attempt in range(4):
            ...
            prompt = (
                f"Professional YouTube thumbnail for Persian language learning video. "
                f"{style}. "
                ...
                f"At top: '120 PERSIAN PHRASES'. In center: '{category_english}'. "
                f"At bottom: 'VELOCITY PERSIAN'. Also: '10 MINUTE LESSON' badge."
            )
            try:
    ...
    lang_fonts = [str(Path(__file__).parent / "fonts" / "NotoSansArabic-Bold.ttf"),
    ...
    draw.text((960, 180), "120 PERSIAN PHRASES", fill=(255, 210, 0), font=f_big, anchor="mm")
