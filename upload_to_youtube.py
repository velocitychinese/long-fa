"""
YouTube Upload Script for Velocity Persian
"""
...
def ensure_playlist(youtube, title="Learn Persian Phrases for Beginners | Velocity Persian", description="All persian phrases videos in one playlist. 🇮🇷 Learn Persian with Velocity Persian!"):
...
def upload_to_youtube(video_info):
    ...
    title = "Learn Persian with Velocity Persian"
    description = ""
    ...
    video_metadata = {
        "snippet": {"title": title, "description": description[:4800],
                     "tags": ["Learn Persian", "Persian Phrases", "Persian Language", "Velocity Persian", "Persian for Beginners"],
                     "categoryId": "27"},
...
def main():
    print("VELOCITY PERSIAN - YOUTUBE UPLOADER")
